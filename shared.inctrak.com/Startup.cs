...
namespace inctrak.com
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.TryAddSingleton<VestingRuleExtractor>();
            services.TryAddSingleton<IVestingDefinitionValidator, VestingDefinitionValidator>();
            services.TryAddSingleton<IVestingScheduleGenerator, VestingScheduleGenerator>();
            services.TryAddSingleton<LocalAiVestingExtractor>();
            services.TryAddSingleton<HybridNlpVestingDefinitionParser>();
            ...
            services.TryAddSingleton<PatternVestingPromptInterpreter>();
