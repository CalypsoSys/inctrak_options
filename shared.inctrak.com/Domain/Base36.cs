    ...
    public struct Base36
    {
        ...
        public long NumericValue
        {
            ...
            set
            {
                ...
                {
                    throw new Exception(string.Format("InvalidBase36ValueException: {0}", value));
                }
        ...
        public string Value
        {
            ...
            set
            {
                ...
                catch
                {
                    ...
                    throw new Exception(string.Format("InvalidBase36NumberException", value));
                }
            }
        }
        ...
        public static long Base36ToNumber(string Base36Value)
        {
            ...
            if (Base36Value == "")
            {
                throw new Exception(string.Format("InvalidBase36NumberException: {0}", Base36Value));
            }
        ...
        public static string NumberToBase36(long NumericValue)
        {
            ...
            {
                throw new Exception(string.Format("InvalidBase36ValueException: {0}", NumericValue));
            }
        }
        ...
        private static byte Base36DigitToNumber(char Base36Digit)
        {
            ...
            {
                throw new Exception(string.Format("InvalidBase36DigitException: {0}", Base36Digit));
            }
        ...
        private static char NumberToBase36Digit(byte NumericValue)
        {
            ...
            if (NumericValue > 35)
            {
                throw new Exception(string.Format("InvalidBase36DigitValueException: {0}", NumericValue));
            }
